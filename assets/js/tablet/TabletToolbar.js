(function (global, document) {
	...
	function TabletToolbar(app) {
		...
		this.toolCatalog = {
			...
			move: { icon: 'move', label: 'Move', action: 'future:Move' },
			...
			zoom: { icon: 'zoom-in', label: 'Zoom', action: 'future:Zoom tool' },
			zoom_window: { icon: 'scan-search', label: 'Zoom Window', action: 'future:Zoom Window' },
			...
			pan: { icon: 'hand', label: 'Pan', action: 'future:Pan tool' },
			...
			copper_zone: { icon: 'layers', label: 'Copper Zone', action: 'future:Copper Zone' },
			copper_pour: { icon: 'droplets', label: 'Copper Pour', action: 'future:Copper Pour' },
			...
			pad_rounded: { icon: 'square-round-corner', label: 'Rounded Pad', action: 'future:Rounded Pad' },
			...
			measure_distance: { icon: 'ruler', label: 'Measure Distance', action: 'future:Measure Distance' },
			measure_angle: { icon: 'triangle-right', label: 'Measure Angle', action: 'future:Measure Angle' },
			...
			align: { icon: 'align-center', label: 'Align', action: 'future:Align' },
			distribute: { icon: 'columns-3', label: 'Distribute', action: 'future:Distribute' },
			duplicate: { icon: 'copy-plus', label: 'Duplicate', action: 'duplicate' },
			array: { icon: 'grid-2x2', label: 'Array', action: 'future:Array' },
