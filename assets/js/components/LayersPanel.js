(function (global, document) {
	...
	LayersPanel.prototype.build = function () {
		var panel = el('section', 'dat-easy-panel dat-easy-layers-panel');
		...
		var tools = el('div', 'dat-easy-panel-tools');
		...
		var actions = el('div', 'dat-easy-action-row');
		[
		...
		this.list = el('div', 'dat-easy-layer-list');
		var resize = el('span', 'dat-easy-resize-handle');
		...
		var launcher = el('button', 'dat-easy-layer-launcher', 'Lớp');
	...
	LayersPanel.prototype.iconButton = function (mode, text) {
		var button = el('span', 'dat-easy-layer-icon', text);
		button.setAttribute('data-layer-toggle', mode);
		return button;
	};

	global.DATPCBLayersPanel = LayersPanel;
})(window, document);
