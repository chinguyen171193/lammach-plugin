(function (global, document) {
	...
	function TabletMode(app) {
		...
		this.contextMenu = new global.DATPCBTabletContextMenu(app);
		this.gesture = new global.DATPCBTabletGesture(app, this.contextMenu);
		this.toolbar = new global.DATPCBTabletToolbar(app);
		this.floatingToolbar = new global.DATPCBTabletFloatingToolbar(app);
		this.aiPanel = new global.DATPCBTabletAIPanel(app);
		this.fab = null;
		this.idleTimer = null;
		this.bind();
		this.createFab();
	...
	TabletMode.prototype.createFab = function () {
		...
		this.fab.className = 'dat-tablet-fab';
		[
			['↶', 'Undo', 'undo'],
			['↷', 'Redo', 'redo'],
			['+', 'Zoom In', 'zoom-in'],
	...
	document.addEventListener('DOMContentLoaded', function () {
		if (global.DATPCBTracerApp) api.bootstrap(global.DATPCBTracerApp);
	});

	global.DATPCBTabletMode = api;
})(window, document);
