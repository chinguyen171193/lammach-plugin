...
class LM_AI_Office_Shortcode {
	...
	public function render_npc_test( $atts ) {
		...
		$walk_animation_relative_path = 'assets/animations/humanoid/walk.fbx';
		$config = array(
			...
			'walk_animation_url' => LM_AI_OFFICE_URL . $walk_animation_relative_path,
			'walk_animation_available' => file_exists( LM_AI_OFFICE_DIR . $walk_animation_relative_path ),
		);
		$assets = new LM_AI_Office_Assets();
