...
class LM_AI_Office_Assets {
	...
	public function public_assets( $in_footer = true ) {
		...
		wp_enqueue_style( 'lm-ai-office-build-mode', LM_AI_OFFICE_URL . 'public/css/office-build-mode.css', array( 'lm-ai-office-public' ), LM_AI_OFFICE_VERSION );
		...
		wp_enqueue_script( 'lm-ai-office-orbit-controls', LM_AI_OFFICE_URL . 'public/js/vendor/OrbitControls.js', array( 'lm-ai-office-three' ), '0.128.0', $in_footer );
		...
		wp_enqueue_script( 'lm-ai-office-build-mode', LM_AI_OFFICE_URL . 'public/js/office-build-mode.js', array( 'lm-ai-office-engine', 'lm-ai-office-gltf-loader', 'lm-ai-office-orbit-controls' ), LM_AI_OFFICE_VERSION, $in_footer );
	...
	public function admin_assets( $hook ) {
		...
		if ( 'lm-ai-office-assets' === $current_page ) {
			wp_enqueue_media();
			wp_enqueue_style( 'lm-ai-office-assets-admin-style', LM_AI_OFFICE_URL . 'admin/css/assets.css', array( 'lm-ai-office-admin' ), LM_AI_OFFICE_VERSION );
			wp_enqueue_script( 'lm-ai-office-three', LM_AI_OFFICE_URL . 'public/js/vendor/three.min.js', array(), '0.128.0', true );
			wp_enqueue_script( 'lm-ai-office-gltf-loader', LM_AI_OFFICE_URL . 'public/js/vendor/GLTFLoader.js', array( 'lm-ai-office-three' ), '0.128.0', true );
			wp_enqueue_script( 'lm-ai-office-assets-admin', LM_AI_OFFICE_URL . 'admin/js/assets.js', array( 'jquery', 'media-editor', 'lm-ai-office-gltf-loader' ), LM_AI_OFFICE_VERSION, true );
		}
