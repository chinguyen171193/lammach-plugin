...
$characters = LM_AI_Office_Characters::definitions(); $actions = LM_AI_Office_Animations::actions(); $notice = sanitize_text_field( wp_unslash( $_GET['character_notice'] ?? '' ) );
?>
<div class="wrap lm-ai-office-admin"><h1>Nhân vật</h1>
...
<?php foreach ( $characters as $character ) : $model = $character['model']; $assets = LM_AI_Office_Animations::assets( $character['id'] ); $profile = LM_AI_Office_Characters::profiles()[ $character['animation_profile'] ]; ?>
<article class="lm-ai-office-animation-card"><h2><?php echo esc_html( $character['name'] ); ?></h2>
