...
Plugin lắng nghe hook `dat_ai_office_event`. Plugin khác có thể gửi sự kiện:
...
REST API công khai: `GET /wp-json/dat-ai-office/v1/status`, `/departments`, `/agents`, `/workflows`, `/events`.
