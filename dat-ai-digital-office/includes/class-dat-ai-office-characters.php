...
final class DAT_AI_Office_Characters {
	...
	public static function definitions() {
		return array(
			...
			'employee_002' => self::definition( 'employee_002', 'Employee 002', 'Chăm sóc khách hàng', 'public/assets/characters/employee_002/employee_002_worker.fbx', 'Cần retarget', array( 'x' => -1.8, 'y' => 0, 'z' => 0 ), self::FEMALE_PROFILE ),
		);
	}
