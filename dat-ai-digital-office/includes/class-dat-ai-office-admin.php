...
class DAT_AI_Office_Admin {
	private $pages = array( 'dat-ai-office' => 'Tổng quan', 'dat-ai-office-departments' => 'Phòng ban', 'dat-ai-office-agents' => 'Nhân viên và AI Agent', 'dat-ai-office-workflows' => 'Workflow', 'dat-ai-office-interface' => 'Giao diện', 'dat-ai-office-connections' => 'Kết nối dữ liệu', 'dat-ai-office-logs' => 'Nhật ký', 'dat-ai-office-preview' => 'Xem trước', 'dat-ai-office-settings' => 'Cài đặt' );
	...
	public function page() {
		...
		include DAT_AI_OFFICE_DIR . 'admin/views/' . ( in_array( $view, array( 'settings', 'departments', 'agents', 'workflows', 'interface', 'connections', 'logs', 'preview' ), true ) ? $view : 'settings' ) . '.php';
	}
}
