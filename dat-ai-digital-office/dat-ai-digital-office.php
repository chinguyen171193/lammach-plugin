...
define( 'DAT_AI_OFFICE_VERSION', '1.7.9' );
define( 'DAT_AI_OFFICE_BUILD', '2026.08.09-employee-002-world-retarget-01' );
...
require_once DAT_AI_OFFICE_DIR . 'includes/class-dat-ai-office-characters.php';
